...
@section('content')
    <div class="max-w-4xl mx-auto p-6">
        <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex justify-between items-center">
                <h2 class="text-xl font-bold text-white">ویرایش بلاگ</h2>
            ...
            <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title"
                           ...
                           value="{{ old('title', $blog->title) }}" placeholder="مثلاً: تاثیر یادگیری زبان دوم">
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                              class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-300 focus:border-blue-500">{{ old('excerpt', $blog->excerpt) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="reading_time" id="reading_time"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-300 focus:border-blue-500"
                           value="{{ old('reading_time', $blog->reading_time) }}" placeholder="مثلاً: 5 دقیقه">
                ...
                <div>
                    ...
                    @if($blog->image)
                        <img src="{{ $blog->image }}" alt="تصویر فعلی" class="mt-2 w-48 h-auto rounded">
                    @endif
                    ...
                    <div>
                        ...
                        <select name="type" id="type"
                            ...
                            @foreach(['blog','news'] as $type)
                                <option value="{{ $type }}" {{ old('type', $blog->type)==$type ? 'selected':'' }}>
                                    {{ ucfirst($type) }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="flex justify-end space-x-3 rtl:space-x-reverse">
                    ...
                    <button type="submit"
                            class="px-5 py-2 rounded-lg bg-yellow-500 text-white hover:bg-yellow-600 shadow transition">
                        ویرایش بلاگ
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        let tags = @json(old('tags', $blog->tags ?? []));
